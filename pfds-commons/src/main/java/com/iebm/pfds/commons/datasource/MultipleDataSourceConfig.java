...
public class MultipleDataSourceConfig implements TransactionManagementConfigurer {
    ...
    @Bean("mutipleDataSource")
	@Primary
    public DataSource datasource() throws Exception{
    	return  MultipleDataSourceRouter.getInstance();
    }
    ...
    protected BeanNameAutoProxyCreator transactionAutoProxy() {
		...
		transactionAutoProxy.setBeanNames(new String[] { "*DaoImpl" });//由于不支持多数据库的事物，故切Service层没有实际上的意义
